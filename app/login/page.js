      ...
      <div className="w-full max-w-md p-10 bg-black/70 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20">
        ...
        <form className="flex flex-col gap-6">
          <div className="flex flex-col gap-2">
            ...
            <input type="text" placeholder="User Name" className="w-full p-3 rounded bg-white text-black outline-none" required />
          </div>
          <div className="flex flex-col gap-2">
            <label className="text-white text-sm font-semibold uppercase tracking-wider">Password</label>
            <input type="password" placeholder="Password" className="border-none w-full p-3 rounded bg-white text-black outline-none" required />
          </div>
